...
var url = "https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/data/index.json"; //json文件路径
$.ajax({
	type: "get",
	url: url,
	dataType: "json",
...
document.addEventListener("click", function (e) {
	...
	if (e.target !== sideBarTitle.children && e.target !== sideBarContent && sideBarIconFlag !== -1 && document.querySelector(
		...
		sideBarButton.innerHTML = `<img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/openMenu.svg">`;
		sideBarIconFlag = -1;
	}
	//监听模态框关闭图标
...
sideBarButton.addEventListener("click", () => {
	...
	if (sideBarIconFlag == -1) {
		...
		sideBarButton.innerHTML = `<img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/closeMenu.svg">`;
...
function openDialog(data) {
	...
	let dialog =
        ...
        <div id="dialog" class="${data.id}">
            <div class="dialog-header">${title}<span id="closeDialog"><img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/closeDialog.svg"></span></div>
			...
			sideBarHtml +=
                ...
                <a id='${item.value}AddCapsule' class="capsule" style="border:1px dashed ${item.color};">
                    <div style="color:${item.color};">
                        <span><img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/addWebsite.svg"></span>
                    </div>
                </a>`;
...
function renderData(id, name, url, color) {
    ...
    <div class="commons">
        ...
        <div class="commons-btn" title="更多选项">
            <img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/moreBtn.svg">
        </div>
    </div>`
}
//添加网址模板
function addCommonsData() {
    ...
    <div class="commons-addbtn" title="添加站点">
        <img src="https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/addWebsite.svg">
    </div>
    </div>`
}
/* 自定义网址结束 */
