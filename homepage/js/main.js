...
storage.stopHot == 'false'
    ? $('#hot-btn').attr(
        'style',
        'background: url(https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/hotg.svg) no-repeat center/cover;'
    )
    : $('#hot-btn').attr(
        'style',
        'background: url(https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/hotk.svg) no-repeat center/cover;'
    );
...
$(function () {
    ...
    var search = {
        data: [
            {
                name: '百度',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/baidu.svg',
                color: '#3385ff',
                url: 'https://www.baidu.com/s?wd='
            }, {
                name: '谷歌',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/google.svg',
                color: '#4c8bf5',
                url: 'https://www.google.com/search?q='
            }, {
                name: '夸克',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/quark.svg',
                color: '#03bc11',
                url: 'https://quark.sm.cn/s?q='
            }, {
                name: '必应',
                color: '#0a8583',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/bing.svg',
                url: 'https://cn.bing.com/search?q='
            }, {
                name: '搜狗',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/sougou.svg',
                color: '#fe620d',
                url: 'https://www.sogou.com/web?query='
            }, {
                name: '好搜',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/so.svg',
                color: '#f8b616',
                url: 'https://www.so.com/s?q='
            }, {
                name: '多吉',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/doge.svg',
                color: '#ffb744',
                url: 'https://www.dogedoge.com/results?q='
            }, {
                name: '头条',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/toutiao.svg',
                color: '#e61a0f',
                url: 'https://m.toutiao.com/search?keyword='
            },{
                name: '秘迹',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/mijisou.svg',
                color: '#e61a0f',
                url: 'https://mijisou.com/?q='
            }, {
                name: '萌搜',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/mengso.svg',
                color: '#e61a0f',
                url: 'https://mengso.com/search?q='
            }, {
                name: 'Yandex',
                icon: 'https://cdn.jsdelivr.net/gh/hnwsz/cdn/homepage/img/so/yandex.svg',
                color: '#e61a0f',
